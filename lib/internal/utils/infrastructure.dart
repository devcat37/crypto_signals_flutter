...
const backgroundColor = Color(0xFF343434);
const surfaceColor = Color(0xFF2B2B2B);
const yellowColor = Color(0xFFEEBC0A);
const blueColor = Color(0xFF54B9F9);
const redColor = Color(0xFFFF6150);
const greenColor = Color(0xFF16CB6B);
